plot3<- function(){
        ...
        ## 3) generate plot of different submetering (1, 2 & 3) across time
        ...
        ## 3) plotting specified time against the three different submeterings
        ...
        with(dataSubsetDT, plot(DateTime, Sub_metering_1, type="l", xlab="Day", ylab="Energy sub metering"))
        lines(dataSubsetDT$DateTime, dataSubsetDT$Sub_metering_2,type="l", col= "red")
        lines(dataSubsetDT$DateTime, dataSubset$Sub_metering_3,type="l", col= "blue")
